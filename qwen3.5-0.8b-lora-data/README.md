---
library_name: peft
model_name: qwen3.5-0.8b-lora-data
tags:
- base_model:adapter:D:\Hugging_Face\models\Qwen3.5-0.8B
- lora
- sft
- transformers
- trl
licence: license
base_model: D:\Hugging_Face\models\Qwen3.5-0.8B
pipeline_tag: text-generation
---

# Model Card for qwen3.5-0.8b-lora-data
